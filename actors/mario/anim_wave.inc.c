...
static const u16 anim_1D_indices_clone[] = {
...
static const s16 anim_1D_values_clone[] = {
...
static const struct Animation anim_1D_clone[] = {
    0,
    189,
    0,
    0,
    0x23,
    ANIMINDEX_NUMPARTS(anim_1D_indices_clone),
    anim_1D_values_clone,
    anim_1D_indices_clone,
    0,
};

const struct Animation *const peniswish[] = {
    anim_1D_clone
};